				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="table-responsive">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger">Delete</a>
							...
							<ul align="right"><a href="<?php echo site_url('pegawai/create/') ?>" type="button" class="btn btn-primary">Insert</a></ul>
						</div>
					</div>
