...
class Pegawai extends CI_Controller {
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('nama', 'nama','min_length[3]','max_length[100]','trim|required');
		...
		$this->form_validation->set_rules('alamat', 'alamat', 'trim|required','min_length[3]','max_length[15]');
		$this->load->model('pegawai_model');	
